...
c. Press 3 to exit
Using select utility then while utility.
![UNFOUND](lap3/lap3_q8(menu).png)

10. Write a script called myarr that ask a user how many elements he wants to enter in an
array, fill the array and then print it.
![UNFOUND](lap3/lap3_q9amyarr.png)

10.Write a script called myavg that calculate average of all numbers entered by a user.
Note: use arrays
![UNFOUND](lap3/lap3_q10_myavg.png)

11.Write a function called mysq that calculate square if its argument.
![UNFOUND](lap3/lap3_q11mysq.png)
